...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/AllCars'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());

var routes = [{
  name: 'inicio',
  path: '/',
  component: Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/AllCars'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}];
